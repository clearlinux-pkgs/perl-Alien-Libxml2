...
Source0  : https://cpan.metacpan.org/authors/id/P/PL/PLICEASE/Alien-Libxml2-0.14.tar.gz
...
%prep
%setup -q -n Alien-Libxml2-0.14
cd %{_builddir}/Alien-Libxml2-0.14
...
cp %{_builddir}/Alien-Libxml2-0.14/LICENSE %{buildroot}/usr/share/package-licenses/perl-Alien-Libxml2/5ebb55d13e4bb56ef0d1fa6aec3401f0055a505e
if test -f Makefile.PL; then
