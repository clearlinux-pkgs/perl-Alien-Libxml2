...
Version  : 0.15
Release  : 7
URL      : https://cpan.metacpan.org/authors/id/P/PL/PLICEASE/Alien-Libxml2-0.15.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/P/PL/PLICEASE/Alien-Libxml2-0.15.tar.gz
...
%prep
%setup -q -n Alien-Libxml2-0.15
cd %{_builddir}/Alien-Libxml2-0.15
...
cp %{_builddir}/Alien-Libxml2-0.15/LICENSE %{buildroot}/usr/share/package-licenses/perl-Alien-Libxml2/5ebb55d13e4bb56ef0d1fa6aec3401f0055a505e
if test -f Makefile.PL; then
